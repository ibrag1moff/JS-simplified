      ...
      <Chapter>
        ...
        <Article>
          <p>
            ...
            <span>important</span> building blocks of the language. A function
            is a <span>reusable block of code</span> that performs a specific
            task. Instead of repeating the same lines of code over and over, you
            can define a <span>function</span> once and call it whenever you
            need it. This makes your <span>code</span> cleaner, more organized,
        ...
        <Article title={"Declaring and Calling a Function"}>
          <p>
            ...
            keyword, followed by the <span>name</span> of the function, a list
            of
  ...
  console.log("Hello, " + name + "!");
        ...
        `}
          ...
          <ul>
            ...
            <li>
              <span className="font-bold">Function Body</span> (everything
              inside of curly braces) – This contains the code that runs when
              the function is called. In this case, it prints a greeting.
            </li>
          </ul>
        </Article>
...
console.log(result); // undefined
        `}
          ...
          <p>
            ...
            message. Since it doesn’t use <span>return,</span> the value stored
            in result is <span>undefined.</span>
          </p>
        </Article>
...
console.dir(greet);
        `}
          ...
          <p>
            When you run this in the <span>browser console,</span> you’ll see
            that the function has properties like <span>name</span> and{" "}
            <span>length,</span> as well as a prototype object. You can even add
            your own custom properties to it. The function also{" "}
            <span>inherits</span> internal methods and behaviors from the
            built-in Function constructor, which is{" "}
            <span>itself an object.</span> This demonstrates that functions in
            JavaScript are not just reusable blocks of code, but also{" "}
            <span>rich objects</span> with their own structure and capabilities.
          </p>
        </Article>
        ...
        <Article title={"Callback functions"}>
          <p>
            ...
            with <span>asynchronous tasks</span> like loading data or waiting
            for user actions.
          </p>
...
setTimeout(function () {
  console.log("This runs after 2 seconds");
        ...
        <Article title={"Functions with Default Parameters"}>
          <p>
            In JavaScript, you can <span>assign</span> default values to
            function parameters. This means that if{" "}
            <span>no value is provided</span> for a parameter when the function
            is called, it will <span>use</span> the default instead.
          </p>
  ...
  return "No message provided.";
        ...
        <Article title={"Immediately Invoked Function Expressions (IIFEs)"}>
          <p>
            ...
            <span>function</span> that runs <span>as soon as</span> it is
            defined. You don’t need to <span>call</span> it manually with its
            name — it
...
(function() {
  console.log("This function runs immediately!");
        ...
        <p>
          ...
          They <span>help</span> us organize code, avoid repetition, and make
          our logic reusable and easier to understand. From simple tasks to
          complex operations, functions play a <span>key role</span> in writing
          clean, efficient, and flexible code. Understanding how to declare,
          call, return values, and use <span>callbacks</span> is essential for
          becoming a strong JavaScript developer.
        </p>
      </Chapter>
    </ProtectedRoute>
  );
