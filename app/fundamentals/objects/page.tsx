...
export default function ObjectsPage() {
  return (
    <Chapter>
      ...
      <Article>
        <p>
          Objects in JavaScript are collections of <span>key-value pairs</span>{" "}
          used to store and <span>organize</span> data. Each key (also called a
          property) maps to a value, which can be <span>any</span> data type,
          including functions and other objects.
        </p>
        <p>
...
let person = {
    ...
    greetings: function(){
        ...
        <p>
          ...
          <span>key-value</span> pairs, where keys are property names and values
          can be any type. As shown in the person object, we can also include{" "}
          <span>functions</span> (called methods) and even other{" "}
          <span>nested</span> objects as values.
        </p>

        <p>
          Methods are <span>functions</span> that are defined as{" "}
          <span>properties</span> of an object. They allow the object to perform
      ...
      <Article title={"Accessing, Modifying, and Deleting Object Properties"}>
        <p>
          ...
          object properties: <span>dot</span> notation and <span>bracket</span>{" "}
          notation. Both allow us to read, create, update, or delete fields in
          an object, <span>depending on</span> the situation.
        </p>
...
console.log(person['name']);        // "John"
        ...
        <p>
          We’ll continue using <span>dot notation</span> moving forward, as it’s
          cleaner, easier to read, and preferred when property names are known
...
delete person.age
        ...
        <div className={"mt-4"}>
          <p>
            You can create <span>new fields</span> by directly assigning a value
            to a property:
          </p>
          <CodeDisplay
            code={`
person.city = "Baku"
      ...
      <Article title={"Property with the Same Name as the Key"}>
        <p>
          ...
          <span>shorthand</span> syntax. This is a concise way to create objects
          in JavaScript.
        </p>
...
console.log(person.age);   // 42
      ...
      >
        <p>
          JavaScript has a concept of a <span>global object,</span> which is the
          top-level object that provides access to globally available variables,
...
console.log(global.greeting); // "Hello from Node"
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <p>
            ...
            <span>globalThis,</span> a standard way to access the global object
            across any environment (browser, Node, etc.).
          </p>
          <CodeDisplay
            code={`
...
console.log(globalThis.test); // 123
        ...
        <p>
          ...
          properties using dot and bracket notation. We also explored important
          concepts like <span>global objects</span> and how objects are used in
          different contexts. Understanding these fundamentals will help you
          efficiently work with objects in your JavaScript projects.
        </p>
      </Article>
    </Chapter>
  );
