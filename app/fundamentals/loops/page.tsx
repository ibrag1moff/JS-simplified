...
console.log(100);
        ...
        <p>
          ...
          different purpose and can be used based on the specific needs of your
          program. There are <span>five</span> main types of loops in
...
for (let i = 1; i <= 100; i++) {
  console.log(i);
        ...
        <p>
          In this example, the loop starts with <span>i = 1,</span> continues to
          run as long as <span>i</span> is less than or equal to 100, and
      ...
      <Article title={"While loop"}>
        <p>
          ...
          loop only requires a condition to be checked before each iteration. If
          the condition evaluates to true, the code inside the loop executes;
...
while (i <= 100) {
  ...
  i++;
        ...
        <p>
          ...
          the condition never becomes false, the loop will run forever, creating
          an infinite loop. Therefore, it’s essential to ensure that something
          inside the loop changes the condition over time.
        </p>
...
while (true) {
  console.log("This will run forever!");
        ...
        <p>
          ...
          with a break statement or by terminating the program). Be careful when
          writing infinite loops—they can crash your program or browser if not
          handled properly.
        </p>
      ...
      <Article title={"Do...while"}>
        <p>
          ...
          whether the condition is true or false. This is because the condition
          is checked after the loop body has run.
        </p>
...
do {
  ...
  i++;
        ...
        <p>
          ...
          condition <span>i &#8804; 100</span> is false, the message will still
          be printed <span>once.</span> This behavior makes{" "}
          <span>do...while</span> useful when you want the code inside the loop
          to run at least once before the condition is <span>evaluated.</span>
        </p>

        <p>
          The main difference between <span>while</span> and{" "}
          <span>do...while</span> is when the condition is checked—while checks
          it before executing the loop body, while do...while checks it after.
        </p>
      </Article>
      ...
      <Article title={"For...in"}>
        <p>
          ...
          <span> access</span> all the keys (or property names) in an object one
          by one.
        </p>
...
for (let key in person) {
  console.log(key, person[key]);
        ...
        <p>
          In this example, the <span>for...in loop</span> goes through each key
          in the person object (name, age, city) and <span>logs</span> both the
          key and its corresponding value.
        </p>

        <p>
          <span> For...in</span> is meant for <span>objects,</span> not arrays.
          Although it can technically be used with arrays, it’s not{" "}
          <span>recommended</span> because it iterates over all enumerable
          properties, including inherited ones, and the order is not guaranteed.
        </p>
        ...
        <div className="flex flex-col gap-3 mt-6">
          ...
          <p>
            ...
            <span>returns an array</span> of an object’s own enumerable property
            names (keys), which you can then loop through using forEach(). This
            approach allows you to perform actions on{" "}
...
Object.keys(person).forEach(key => {
  console.log(key, person[key]);
          ...
          <p>
            ...
            <span> forEach() loops over each key,</span> allowing access to both
            the key and its corresponding value. This is a <span>clean</span>{" "}
            and <span>readable </span>
...
console.log(Object.values(person)); // ["John", 25, "Baku"]
      ...
      <Article title={"For...of"}>
        <p>
          ...
          over property keys, for...of iterates directly over the values of the
          iterable.
        </p>
...
for (let char of "Hello") {
  console.log(char);
        ...
        <p>
          For...of does not work on <span>plain objects directly,</span> because
          objects are not iterable by default. If you want to iterate over an
          object’s values or entries, you can use <span>Object.values()</span>{" "}
          in combination with <span>for...of.</span>
        </p>
      </Article>
      ...
      <Article>
        ...
        <ul>
          ...
          <li>
            <span className="font-bold">do...while loop </span> guarantees that
            the code runs at least once before checking the condition.
          </li>

          <li>
            <span className="font-bold">for...in loop</span> is used to iterate
            over the keys of an object.
          </li>

          <li>
            <span className="font-bold">for...of loop</span> is used to iterate
            over the values of iterable objects like arrays and strings.
          </li>
        </ul>

        <p>
          Additionally, while <span>forEach()</span> is an array method, it can
          be used with objects by <span>converting</span> their keys, values
          into <span>arrays</span> using Object.keys(), Object.values().
        </p>
      </Article>
    </Chapter>
  );
