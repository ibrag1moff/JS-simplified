    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: 2,
          name: "Interpreter",
          href: "/fundamentals/interpreter",
          active: isNavItemActive(pathname, "/fundamentals/interpreter"),
          access: AccessLevel.FREE_WITH_LOGIN
        },
        {
          id: 3,
          name: "Type system",
          href: "/fundamentals/type-system",
          active: isNavItemActive(pathname, "/fundamentals/type-system"),
          access: AccessLevel.PUBLIC
        },
        {
          id: 4,
        ...
        },
        {
          id: 8,
          name: "Statements",
          href: "/fundamentals/statements",
          active: isNavItemActive(pathname, "/fundamentals/statements"),
          access: AccessLevel.FREE_WITH_LOGIN
        },
        {
          id: 9,
