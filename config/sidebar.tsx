...
export const NavItems = () => {
  ...
  //         href: "/",
  //         active: isNavItemActive(pathname, "/a"),
  //       },
  //       {
  //         id: 2,
  //         name: "Variables & Constants",
  //         href: "/",
  //         active: isNavItemActive(pathname, "/s"),
  //       },
  //       {
  //         id: 3,
  //         name: "Data types",
  //         href: "/",
  //         active: isNavItemActive(pathname, "/w"),
  //       },
  //       {
  //         id: 4,
  //         name: "Operators & Conditionals",
  //         href: "/",
  //         active: isNavItemActive(pathname, "/r"),
  //       },
  //     ],
  //   },
  //   {
  //     groupName: "Control Flow & Functions",
  //     items: [
  //       {
  //         id: 5,
  //         name: "Loops",
  //         href: "/",
  //         active: isNavItemActive(pathname, "/y"),
  //       },
  //       {
  //         id: 6,
  //         name: "Functions",
  //         href: "/",
  //         active: isNavItemActive(pathname, "/n"),
  //       },
  //     ],
  //   },
  //   {
  //     groupName: "Arrays & Objects",
  //     items: [
  //       {
  //         id: 7,
